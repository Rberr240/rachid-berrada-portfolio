...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    summary:
      "Projet personnel de recherche autour d'une architecture d'assistant intelligent combinant orchestration, mémoire, automatisation et modèles d'IA.",
    result:
    ...
    tags: ["Node.js", "LangGraph", "Multi-agent", "R&D"],
    ...
    placeholder: false,
    caseStudy: {
      heroSubtitle: "Une architecture personnelle d'assistant intelligent multi-agents.",
      need: [
        "Un projet personnel de recherche et développement, sans commande client, pour explorer l'orchestration d'agents IA, la mémoire long-terme et l'autonomie logicielle.",
      ],
      solution: [
        "Un orchestrateur central (LangGraph) route les tâches vers des agents spécialisés : recherche, code, vision, voix, DevOps, média.",
        "Un système de mémoire dédié (gestionnaire et routeur de mémoire) et des modules d'autonomie (planification de tâches, réflexion, auto-amélioration).",
        "L'architecture est documentée dans une vingtaine de documents dédiés (cycle de vie, bus d'événements, mémoire, sécurité, feuille de route…).",
      ],
      features: [
        "Orchestration multi-agents (LangGraph)",
        "Agents spécialisés : recherche, code, vision, voix, DevOps, média",
        "Système de mémoire dédié",
        "Modules d'autonomie : planification, réflexion, auto-amélioration",
        "Intégration à plusieurs fournisseurs de modèles IA",
      ],
      technologies: [
        { name: "Node.js" },
        { name: "LangChain / LangGraph" },
        { name: "Multi-LLM", note: "OpenAI, Anthropic, Google, Groq" },
        { name: "Qdrant", note: "mémoire vectorielle" },
        { name: "SQLite" },
      ],
      metaDescription:
        "Case study : JARVIS, projet personnel de R&D en intelligence artificielle — orchestration multi-agents, mémoire et autonomie.",
    },
  },
];
